// Port verbatim (SPEC-04) de public/js/audio-recorder.js — lógica de navegador
// agnóstica de UI, solo tipada. NO cambiar comportamiento: el contrato de captura
// (Promise→blob, distinción intencional/externo, timer, fix de pausa) se preserva.

export type ExternalStopMeta = {
...
export type DiagHook = (type: string, payload?: unknown) => void
export type ExternalStopHook = (blob: Blob, meta: ExternalStopMeta) => void
...
export class AudioRecorder {
  ...
  private _elapsedBeforePause = 0 // acumulado antes de pausar
  private _timerInterval: ReturnType<typeof setInterval> | null = null
  onTimeUpdate: ((seconds: number) => void) | null = null // callback(seconds)
  ...
  onDiag: DiagHook | null = null
  onExternalStop: ExternalStopHook | null = null
  private _intentionalStop = false // lo pone stop() antes del stop() nativo
  private _stopResolve: ((blob: Blob | null) => void) | null = null // resuelve la promesa de stop()
