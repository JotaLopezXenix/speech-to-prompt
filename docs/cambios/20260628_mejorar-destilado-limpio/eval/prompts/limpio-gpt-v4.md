...
7. PRESERVAR LA VOZ Y LA PERSONA DEL HABLANTE. Si el hablante habla en PRIMERA PERSONA
   ...
   transformación editorial que falta a la fidelidad. Tampoco uses pasivas perifrásticas donde
   el hablante usó activa: si dijo "ideas que al principio estaban bien, al final han cambiado",
   NO escribas "ideas que pueden ser cambiadas". Si algo se dijo en neutro, queda neutro.
...
11. LA SECCIÓN DE PREGUNTAS ABIERTAS contiene EXCLUSIVAMENTE dos cosas: (a) ambigüedades o
    ...
    NO CONVIERTAS EN PREGUNTA una esperanza, suposición o expectativa del hablante. Si el
    hablante dice "supongo que se activa la funcionalidad de varios segmentos, espero que sea
    así", eso es CONTENIDO en su voz (va en el cuerpo tal cual), NO una pregunta de control de
    calidad como "¿está correctamente implementada la funcionalidad de varios segmentos?". Esa
    reformulación es una pregunta de diseño que él no hizo: PROHIBIDA. Solo cuenta como
    ambigüedad (a) lo que el hablante deja EXPLÍCITAMENTE sin resolver o se pregunta él mismo.
