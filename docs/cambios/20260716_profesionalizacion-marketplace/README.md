...
| 3 — `marketplace-transactable` | `ciclo-3-marketplace-transactable/` | Diseño CERRADO. **Fase 2 (spec) EN CURSO**: `SPEC-01` (modelo de acceso + gate) **escrito** — siguiente `/jcc-implement` SPEC-01 (o seguir specs 02–06). Burocracia Partner Center **mapeada** (cuenta ✅, payout ✅, fiscal a falta de 1 acción — ver runbook). |
