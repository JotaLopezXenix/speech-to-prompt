...
| 2 — `frontend-mobile-first` | `ciclo-2-frontend-mobile-first/` | **análisis cerrado** (DESIGN) → siguiente: actividad 2a (diseño/maquetas), luego `/jcc-spec` del 2b |
...
- **Ciclo 2** `ciclo-2-frontend-mobile-first/`: `DESIGN.md`.
